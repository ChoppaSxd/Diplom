    ...
    return (
        <div className="Nav">
            <Navbar bg="dark" variant="dark" expand="lg" fixed="top">
                <Container>
                    <Navbar.Brand href="#home"><Link to="/main" className="logos">Циклова комісія інформатики</Link></Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto">
                            ...
                            <Nav.Link href="#someinfo" className="d-flex"><Link to="/info" href="#"><Button className="btn-hover-navs color-2" variant="outline-dark">Викладачі</Button></Link></Nav.Link>
                            ...
                            <Nav.Link href="#">
                                <Dropdown isOpen={dropdownOpen} toggle={toggle} className="d-flex">
                                    ...
                                    <Dropdown.Menu>
                                        ...
                                        <Dropdown.Item eventKey="2"><Link className="item_button" to="/wedding" href="#">Студенту</Link></Dropdown.Item>
                                        <Dropdown.Item eventKey="3"><Link className="item_button" to="/banquest" href="#">Про коледж</Link></Dropdown.Item>
                                        <Dropdown.Item eventKey="4"><Link className="item_button" to="/corporate" href="#">Віртуальний тур</Link></Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </Nav.Link>
                        </Nav>
